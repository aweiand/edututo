...
<form name="alteraCurso" action="../codes/altC.php" method="post">
<?php 
$cid = $_POST['cid'];
$sql = "select * from cursos where cid=".$cid."";
$linha = mysql_fetch_assoc(mysql_query($sql));
 ?>
<tr>
  <td>Curso:</td><td>Id:<?php echo " ".$cid ?><td colspan="3">
<input name="curso" type="text" id="curso" value="<?php echo " ".$linha['cdesc'] ?>" />
</td>
<td><input name="nivel" type="text" id="nivel" value="<?php echo $linha['cnivel'] ?>" />
<td colspan="3">
<input type="hidden" name="cid" value="<?php echo $cid ?>" />
<input type="submit" value="Alterar" name="altCurso" /></td></tr>
</form>
</table>
</div>
<div id="Rodape">
