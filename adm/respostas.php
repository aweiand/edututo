...
<form name="insereResposta" action="../codes/insResp.php" method="post">
<tr>
  <td>Respostas:</td><td colspan="3"><input type="text" name="resposta" id="resposta" /></td><td colspan="3"><input type="submit" value="Inserir" name="insPerg" /></td></tr>
</form>
<?php 
...
?>
<tr>
<td colspan="5"><?php echo "Rid - ".$rid." | Resp. - ".$linha['rresposta'] ?></td>
<td>
<form action="altResp.php" name="altResp" method="POST">
<input type="hidden" name="rid" value="<?php echo $rid ?>" />
<input type="submit" value="Alterar" />
</form>
</td>
<td>
<form name="delResp" action="../codes/delResp.php" method="get">
<input type="hidden" name="rid" value="<?php echo $rid ?>" />
