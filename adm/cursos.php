...
<form name="insereCurso" action="../codes/insCurso.php" method="post">
<tr>
  <td>Curso:</td><td colspan="3"><input type="text" name="curso" id="curso" /></td><td>Nivel:</td><td><input type="text" id="nivel" name="nivel" value="0" /></td><td colspan="3"><input type="submit" value="Inserir" name="insPerg" /></td></tr>
</form>
<?php 
...
?>
<tr>
<td colspan="5"><?php echo "Cid - ".$cid." | Perg. - ".$linha['cdesc']." | Nivel. - ".$linha['cnivel'] ?></td>
<td>
<form action="altCurso.php" name="altCurso" method="POST">
<input type="hidden" name="cid" value="<?php echo $cid ?>" />
<input type="submit" value="Alterar" />
</form>
</td>
<td>
<form name="delCurso" action="../codes/delCurso.php" method="get">
<input type="hidden" name="cid" value="<?php echo $cid ?>" />
