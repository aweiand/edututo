...
<form name="alteraPergunta" action="../codes/altP.php" method="post">
<?php 
$pid = $_POST['pid'];
$sql = "select * from perguntas where pid=".$pid."";
$linha = mysql_fetch_assoc(mysql_query($sql));
 ?>
<tr><td>Pergunta:</td><td>Id:<?php echo " ".$pid ?><td colspan="3">
<input name="pergunta" type="text" id="pergunta" value="<?php echo " ".$linha['ppergunta'] ?>" />
</td><td colspan="3">
<input type="hidden" name="pid" value="<?php echo $pid ?>" />
<input type="submit" value="Alterar" name="altPerg" /></td></tr>
</form>
</table>
</div>
<div id="Rodape">
